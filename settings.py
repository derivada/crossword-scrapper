...
# Configuration file
RUN_HEADLESS = True # Run without opening a browser window

# Valid values: "experto", "mambrino", "tarkus", "mini"
CROSSWORD_COLLECTION = "tarkus"
...
END_DATE = "20240326"
DATA_FILE = "data_tarkus.pkl"
SKIP = [("experto", "20230103"), ("tarkus", "20211225"), ("tarkus", "20220609"), ("tarkus", "20220524"),  ("experto", "20231207"), ("experto", "20231226"),
        ("experto", "20231227"),("experto", "20231228"),("experto", "20231229"), ("tarkus", "20220731"), ("tarkus", "20221011"), ("tarkus", "20230306"),
        ("tarkus", "20230517"), ("tarkus", "20231123")] # Special crosswords that crash the scraper and are not worth the added complexity of scraping them
